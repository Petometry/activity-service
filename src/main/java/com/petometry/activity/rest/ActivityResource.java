...
public class ActivityResource extends AbstractResource {
    ...
    @PostMapping()
    public ActivityDto startNewActivity(@AuthenticationPrincipal Jwt jwt, @RequestBody ActivityDto activityRequest) {
        // @formatter:on
        String userId = getUserId(jwt);
    ...
    // @formatter:off
    @Operation(summary = "Stops current activity", description = "Stops the activity that the user is currently on. No reward will be given")
    @ApiResponses(value = {
